<template>
	<header>
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<ul class="navbar-nav">
				<!-- <li><router-link tag='div' to='/' class="nav-link"></router-link></li> -->
				<!-- <li><router-link :to='homeLink' class='nav-link'></router-link></li> -->
				<li>
			...
			<ul class="navbar-nav ml-auto">
				...
				<li>
					<router-link :to="{name:'loginLink'}" v-show="isLogin" class="nav-link">
						[退出]
					</router-link>
				</li>
				<li>
